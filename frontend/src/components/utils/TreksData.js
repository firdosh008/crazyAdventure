...
export const treksData = [
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "The transition from greenery to deserted cold mountains when you start the trek is an amazing experience. You will be able to see the far reaches of the planet which are still untouched by human civilizations. Even though this is a difficult trek, strong determination always pays off and you will see yourself standing over the height of 6,000 m above the sea level.",
      ],
    },
    duration: "8 Days",
    distance: "22 km",
    ...
    itinerary: [
      ...
      {
        day: "Day 3",
        title: "AKeylong / Jispato Bharatpur",
        description: [
  ...
  {
    name: "Stok Kangri",
    title: "Stok Kangri - Valley Views",
    tourCode: "122132158",
    price: "₹ 19999",
    mapImg: "",
    overview: {
      title: "Stok Kangri",
      paragraphs: [
        "Stok Kangri is a fascinating trek located in the northern Ladakh region of India. This peak has gained a lot of popularity in the last few years and attracts tourists from every corner of the world. Stok Kangri is situated in far, cold, deserted areas of the Himalayas and therefore it offers complete peace to the visitors.",

        "The sudden changes in the scenery throughout the trek because of the many ridges is another reason why a lot of people prefer this trek. The hike will take you through exotic locations and you will be able to spot the famous Karakoram and Zanskar mountain ranges.",
      ],
    },
    duration: "8 Days",
    distance: "80 km",
    ...
    itinerary: [
      {
        ...
        title: "Arrival Leh",
        description: [
          "The first day will be check-in at Leh. The place is well connected to New Delhi and you will not have problems finding your way here. You will be briefed about the trek by the leader and you can spend the rest of the day acclimatizing and exploring the local Leh market for any supplies that you might need on the trek. Night stay will be at a guesthouse.",
        ],
        briefOverview: [
      ...
      },
      {
        ...
        description: [
          "Since this trek will take us to extremely high altitudes, it is very important to properly acclimate your body to the environment. We will spend another day in Leh visiting and exploring the natural as well as the cultural beauty of this place. There are a lot of beautiful temples and monasteries in the area that you can check out. Overnight stay will be at a guesthouse.",
        ],
        briefOverview: ["Acclimatization Day", "Explore the area around"],
      },
      {
        day: "Day 3",
        title: "Leh to Chang Ma via Stok Village",
        description: [
          "On the third day our destination will be Chang Ma via Stok Village. We will be driving 35 Km to Stok and then a trek of about 4 hours will take us to our destination. The drive to Stok is an exciting and adventurous ride filled with the natural beauty of lush green trees.",

          "Stok village which lies in the southern region of Leh is famous for the Royal Palace where the recently crowned king of Leh lives. The trek to Chang Ma from Stok is a bit difficult and you might have to walk on the snow. Overnight stay in camps.",
        ],
        briefOverview: [
          ...
          "Trekking Time - 4 Hours",
          "Max Altitude - 12,950 ft.",
          "Night stay in tents.",
        ],
      },
      {
        day: "Day 4",
        title: "Chang Ma to Mankorma",
        description: [
          "On the fourth day of the Stok Kangri Trek, you will get to see the real beauty of Ladakh and get the answer to the question of - Why is Ladakh famous as a cold desert? The complete trail will take you through the grey, barren landscapes with few streams crossing your path. Today’s trek is a relatively easy hike along the river on a slightly ascending trail. Overnight stay will be in tents.",
        ],
        briefOverview: [
      ...
      {
        day: "Day 5",
        title: "Mankorma to Base camp",
        description: [
          "A 4 Km trek from Mankorma will take you to Stok Kangri Base Camp at an extremely high altitude of 16,300 ft. The trail is a moderate - difficult level ascent towards the camp.",

          "The base camp is located in a scenic location in a grassy area with a number of small waterbodies in the form of lakes and streams around the camp. You can trek a couple of kilometers to the upper areas of the base camp to get the views of some beautiful peaks like - Gulap Kangri & Parcha Kangri.",

          "Tomorrow is going to be another acclimatization day as there will be a drastic change in the environment as we climb to the peak. Overnight stay in camps.",
        ],
        briefOverview: [
          "Trekking Distance - 4 Km",
          "Trekking Time - 5 Hours",
      ...
      {
        day: "Day 6",
        title: "Rest day training day",
        description: [
          "Today is another acclimatization day as we will be climbing up to an altitude of 20,080 feet tomorrow. Take some time to explore the area around you but make sure not to walk too much or do heavy exercise to conserve energy for the big day tomorrow.",

          "The trek leader will also brief you about the upcoming trek and let you know about the challenges that we might face on our climb to the summit including the terrain and weather conditions. After briefing and planning for climbing the summit, you will also be taught how to use technical equipment that we might need on the trek.",

          "Night stay will be in tents.",
        ],
        briefOverview: ["Acclimatization Day", "Planning for the peak"],
      },
      {
        day: "Day 7",
        title: "Base camp to Stok Kangri Top & back to base camp.",
        description: [
          "The day for the big climb has finally arrived and today, we will be crossing over the 6000 m mark. We will start early in the morning as the 7 Km climb up to the summit will take at least 9 hours to complete and therefore you should be mentally and psychologically prepared for the situation. At the top, you will get a spellbinding view of the entire area. You will have clear views of the Karakoram, Saser Kangri and Zanskar range dominating the skies. Be prepared for the difficult climb down to the base camp where we will spend the night.",
        ],
        briefOverview: [
      ...
      {
        day: "Day 8",
        title: " Base camp to Stok Village and drive to Leh",
        description: [
          "Today is the final day of the Stok Kangri Trek and we will be walking down 13 Km on a familiar trail back to Stok village. Be prepared for a long difficult hike back. At Stok, a vehicle waiting for you will take you back to Leh and your trek will come to an end with a beautiful journey.",
        ],
        briefOverview: [
          "Trekking Distance - 13 Km",
          "Trekking Time - 7 Hours",
  ...
  },
  {
    ...
    title: "Markha Valley Trek - A Journey Into Unknown",
    tourCode: "122132159",
    price: "₹ 18499",
    mapImg: "",
    overview: {
      ...
      paragraphs: [
        "Markha Valley, located in Leh-Ladakh, is one of the largest valleys in the region. The trek gives you an opportunity to explore the cultural heritage of the Leh-Ladakh area. A number of small villages like Skui, Markha, Hankar, and Nimaling along with monasteries, ancient ruins, and temples make this trek an exciting journey. Tacha Monastery is a must-visit. The trek is located in Hemis National Park, and you can spot a wide variety of fauna and flora throughout the journey. You might spot Mountain Sheep, Argali, Rabbits, or even snow leopards on the way.",

        "On the Markha Valley trek, you can view the mighty Himalayan Ranges in the area, with the most famous being the Karakoram and Ladakh ranges. The mesmerizing sight of K2 mountain, Stok Kangri, and Kang Yatse peaks will also greet you on your way.",
      ],
    },
    duration: "8 Days",
    distance: "65 km",
    ...
    itinerary: [
      {
        ...
        title: "Arrival Leh",
        description: [
          "The first day is set aside for check-in at Leh. The Leh-Ladakh area is well connected to the National Capital New Delhi, and once you reach there, you will not have any problems finding your way to Leh. Today we will be exploring Leh, as it is located at a high altitude of 11,000 ft, and such sudden drastic changes in altitude can trigger AMS.",

          "You can check out the local market in the area to purchase anything that you might need for your journey ahead. Avoid traveling to higher altitudes. Leh is also famous for its beautiful monasteries and temples, which also serve as a major attraction for tourists.",
        ],
        briefOverview: [
          "Check in at Leh",
          "Network - Available (Only Postpaid)",
          "Max Altitude - 11,500 ft.",
      ...
      {
        day: "Day 2",
        title: "Acclimatisation at Leh",
        description: [
          "Today is the acclimatization day and having an extra day for this purpose will help you to get better used to the environment at high altitude. Try to spend time outside. You can hike up to Shey Palace, Thiksey Monastery or Thiksey Gompa. But remember not to stress your body too much and conserve energy for the upcoming trek.",
        ],
        briefOverview: [
          "Acclimatization Day",
      ...
      {
        day: "Day 3",
        title: "Drive Leh to Chilling and trek to Skiu",
        description: [
          "After having breakfast in the morning, we will drive 65 Km through a picturesque landscape to Chilling. On our way, you will be crossing the famous Gurudwara Pathar Sahib and the Magnet Hill. The 'sangam' of Indus & Zanskar rivers is another attraction to look out for during the ride. As we reach closer to Chilling, you will notice a drastic change in the landscape around you. We will enter the valley full of Juniper & Alpine trees which will keep you company until we reach Chilling.",

          "The trek to Skiu from Chilling starts with a steep ascent. As we keep walking, we will reach Kaya-Do and make our first river crossing of the trek. Skiu village is located at the confluence of Shangri Nala & Markha, and we will be camping here for tonight.",
        ],
        briefOverview: [
      ...
      },
      {
        ...
        title: "Skui to Sara",
        description: [
          "We will start walking on a well-marked, easy & flat trail. Keep an eye out for any rare birds or animals that you might spot on the way. The hike goes along the Markha river and crosses a sparsely populated forest that opens up near a wooden bridge at Zanpa. Another 40 minutes walk from here will take us to Nagding. Nagding is famous for paintings that are found here in the meditation caves.",

          "After walking for an hour from Nagding, we will reach the entrance of Sara Village. You can explore the area around and enjoy the beauty of nature. Night stay in tents.",
        ],
        briefOverview: [
          "Trekking Distance - 10 Km",
          "Trekking Time - 4 Hours",
          "Max Altitude - 11,490 ft",
          "Overnight stay in tents",
        ],
      },
      {
        day: "Day 5",
        title: "Sara to Markha",
        description: [
          "Today is another easy day and we will start again on an easy, well-defined trail. On the way, you will spot stones engraved with Buddhist prayers, and some of them are in Sanskrit. After walking for 30 minutes from Sara village, we will reach Chalak village, where we can stop for tea to re-energize ourselves.",

          "Markha Village is one of the largest villages in the area, and we will reach there by walking along the Markha river. Overnight stay in camps.",
        ],
        briefOverview: [
          "Trekking Distance - 10 Km",
          "Trekking Time - 4 Hours",
      ...
      },
      {
        ...
        description: [
          "Today's trail will take us through the least visited parts of the area. The hike is beautiful with a number of streams crossing our way. We will stop for refreshments at Umlung, which is famous for a beautiful monastery located there.",

          "As we cross Umlung, you will get a glimpse of the mighty Mt. Kang Yatse (6,400 m). Once again, we will cross many streams to reach the final destination for the day at Hankar Village. The village is located in a beautiful setting with the Tacha Monastery visible on top of a mountain.",
        ],
        briefOverview: [
          "Trekking Distance - 11 Km",
          "Trekking Time - 6 Hours",
      ...
      },
      {
        ...
        description: [
          "We will leave Hankar early in the morning and head towards our next destination at Nimaling. The trail is a beautiful walk through nature and you will spot the pasture of Thochuntse after hiking for about 2 hours. The Mt. Kang Yatse seems to keep getting bigger as we inch closer to our destination. After crossing a couple of streams, the trail enters into a grassland and you will see twin lakes in this area. This grassland is used by sheep, goats, and other herbivorous animals for grazing.",

          "Nimaling is an amazing camping location and this is the second highest point we will touch on this trek, which is 15,400 ft. It can snow anytime at this high altitude and therefore we will have to come prepared.",
        ],
        briefOverview: [
          "Trekking Distance - 9 Km",
          "Trekking Time - 4 Hours",
      ...
      {
        day: "Day 8",
        title: " Nimaling to Chokdo via Kongmaru La drive to Leh",
        description: [
          "Today is the last day of the Markha Valley Trek and it is going to be a long one. Today we will be trekking a total of 16 Km for around 8 hours, but every step you take will be totally worth the scenic beauty that you will experience in this location. After a tiring climb of 2 hours, we will reach Kongmaru La Pass at an altitude of 17,100 ft. The clear view of the Karakoram Range and the second highest peak in the world, K2, will leave you at a loss of words.",

          "As we say goodbye to Kongmaru La, the trail will enter a steep descent followed by a gradual descent to Chkirmo Village. After climbing down gradually on a rocky trail, we will reach Chokdo, and a vehicle waiting for us will take us back to Leh.",
        ],
        briefOverview: [
          "Trekking Distance - 16 Km",
          "Trekking Time - 8 Hours",
    ...
    howToReach: {
      byAir:
        "Flights to Leh are available for booking all year round, even in winters. The Leh Airport is a military airport and security checks are a little more stringent than usual. Please carry a printout of your e-ticket before entering, failing which you might be denied entry. From the airport, you can easily get taxis that will take you to your hotel/resort.",
      // byBus:"From Jammu and Kashmir or from Manali, if you're planning to approach Leh in a bus, get ready for an adventurous bumpy ride. It’s got what it takes to become the ride of a lifetime and will take at least 4 days (starting at New Delhi).",
      // byTrain: "Pathankot and Chandigarh are the closest railway stations to Leh, still a three-day bus ride away. This is one route that most travellers to Leh avoid. ",
      // selfDrive: "For adventure lovers around the world, hitting the road to Leh is a dream they look forward to living at all times. They may pick up a motorbike, a jeep, an SUV or try to tackle this journey on a bicycle, but driving to Leh is certainly an adventure. You can either take the (lower) road from Jammu and Kashmir or the (higher) road from Rohtang La via Keylong and Sarchu.",
    },
    essentials: [
  ...
  },
  {
    ...
    title: "Chadar Trek Frozen River - Walk On The Frozen River",
    tourCode: "122132160",
    price: "₹ 23499",
    mapImg: "",
    overview: {
      ...
      paragraphs: [
        "Chadar trek is one of the greatest expedition treks in India that every trekker should do once in their lifetime. Chadar is a trek that every trekker would love to conquer. This is a fascinating and dream place that everyone would love to go to at once. Chadar trek is located at an altitude of 11,480 feet and begins from Leh.",

        "Leh is a city that falls under the Leh district of the Indian state of Jammu and Kashmir. Chadar trek is a 9-day expedition. On the first day, when you get entered in Leh, you can explore much more including the ancient culture and rich heritage of this city. You should not miss this chance of exploring the city. Leh’s weather also helps you in acclimatization.",

        "On the second day, you visit Leh Shingra Yokma. You can explore the history of the Chadar trek here to interact with the local people of this region. Here, you get a practice session under the guidance of the trek leader. In which you practice how to walk on thin ice and use the sleeping bag, etc. And learn everything that is important to practice for the Chadar trek.",

        "On the third day, you move towards Shingra Koma. You can experience both the beauty of this place and nervousness equally to getting down from the ice glass. In fact, the ice sheet might be broken at places. To avoid weak ice patches, walk in line, and stay alert at every moment while walking through the ice glass. Somewhere you see the light of the sun coming across the magnificent mountains, that time a white carpet on a frozen river dazzles your eyes.",

        "On the fourth day, you move further towards Tibb caves where you can capture a bird’s eye view of a beautiful Tsumo Bhao waterfall. Passing through the towering valley when you see a picturesque sight, you get amazed.",

        "On the fifth day, you step out for Nerak campsite. Reaching this place, you get enthralled to see a huge frozen Nerak waterfall.",

        "Finally, you come back from your trek place Nerak to Leh on the ninth day and you go back to your respective cities. This Chadar trek will definitely prove to be a milestone in your life.",
      ],
    },
    duration: "8 Days",
    distance: "62 km",
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Reporting day at Leh",
        description: [
          "You will be required to reach Leh from where you will be picked up by The Crazy Mountaineers team. You will be checked in to a hotel where you can stay for a while to acclimatize to the cold temperature. You can rest for a while and check out the Leh local market for any last-minute trek essentials that you might need. Be sure to carry warm clothes with you as the temperatures easily fall below sub-zero temperatures.",
        ],
        briefOverview: [
          "Altitude: 11,400 ft.",
          "Orientation & Briefing of the trek.",
          "Check-in at hotel.",
          "Bring a copy of ID proof and 2 photographs.",
          "Network is available (only post-paid).",
          "ATM is available.",
          "Spend the day in the room to acclimatize.",
        ],
      },
      {
        day: "Day 2",
        title: "Acclimatization Day",
        description: [
          "As per new regulations, anyone embarking upon Chadar Trek is required to spend at least 2 days in Leh to help your body completely acclimatize with the weather conditions at Leh. This is mandatory and should be followed by every trekker so that you don't face problems like (AMS) during the trek. Today you can spend your day exploring other places in the city.",
        ],
        briefOverview: [
      ...
      {
        day: "Day 3",
        title: "Leh to Tsomo Paldar via Chilling & Tilad do",
        description: [
          "Driving along the Zanskar river for about one and a half hours, we will reach Chilling.",
          "After reaching Chilling, the hike begins; walking in gumboots can be challenging at first, so make sure to walk carefully and check the surface of the ice for steadiness with the walking stick before stepping on it.",
          "Walking for half an hour will take us to our first camping site at Tsomo Paldar, and we will be camping here in sub-zero temperature.",
        ],
        briefOverview: [
          "Altitude: 11,400 ft",
          "Drive: 65 km, 3-4 hrs",
          ...
          "Stay in tents",
          "Drive through: Gurudwara Pathar Sahib, Magnetic Hill, and the confluence of the Zanskar and Indus rivers",
        ],
      },
      {
        day: "Day 4",
        title: "Tsomo Paldar to Tibb Cave",
        description: [
          "We wake up in the morning and after breakfast, as we start walking towards Tibb Cave, we will slowly gain altitude from 11,400 feet at Tsomo Paldar to Tibb Cave at 11,800 feet. As we continue towards our next campsite, you will be able to see some of the most beautiful frozen waterfalls that are in the area. The source of some of these waterfalls is still unknown. We will be trekking along the mighty Zanskar river and you will be able to see the artistic work of nature at its best. Overnight stay will be at camps near the Tibb cave.",
        ],
        briefOverview: [
          ...
          "Sunshine only available around 9-10 am",
          "Stay in tent",
        ],
      },
      {
        day: "Day 5",
        title: "Tibb Cave to Nerak",
        description: [
          "Today’s target is to camp at Nerak which is 13 km from Tibb Cave. Nerak is the main attraction of the Chadar trek with the famous frozen waterfall, a nature’s masterpiece located there. This frozen waterfall attracts a lot of trekkers from all over the world. If we reach Nerak on time we can also visit the Nerak village. It is vital that you wear proper warm clothing layers because the temperature here can hit a bottom of -30 degrees Celsius during the night time. Today will be camping at Nerak at a little distance from the frozen waterfall.",
        ],
        briefOverview: [
          ...
          "If we reach on time at Nerak camp, we can visit Nerak village",
      ...
      {
        day: "Day 6",
        title: " Nerak – Tibb Cave",
        description: [
          "Today we retrace our steps back on the same route that we came from, back to Tibb cave, where we camp for the night.",
        ],
        briefOverview: [
          "Altitude: 10,800 to 11,100 ft",
          "Trek: 13 km, 6-7 hrs",
      ...
      {
        day: "Day 8",
        title: "Gyalpo to Tilad do to Leh",
        description: [
          "Today we will leave Gyalpo and trek to Tilad Do. Once we reach Tilad Do, you will be picked up and driven to Leh. Expected arrival time at Leh is late evening.",
        ],
        briefOverview: [
          "Altitude: 10,500 ft to 10,300 ft and drive to 11,400 ft",
          "Trek: 6 km, 3-4 hrs",
          "Drive: 65 km, 3-4 hrs",
          "Hot lunch on the way",
          "Make sure you fill your thermos with warm water before you leave",
          "Reach Leh by 6:30 pm",
  ...
  },
  {
    ...
    title: "Kedarnath Yatra - First step to Char Dham",
    tourCode: "122132161",
    price: "₹ 11,750",
    mapImg: "",
    overview: {
      ...
      paragraphs: [
        "Kedarnath Yatra is a sacred pilgrimage according to the Hindu religion.",
        "Kedarnath temple is situated in the Rudraprayag district of Uttarakhand, India.",
        "Kedarnath is one of the Char Dham temples (Badrinath, Gangotri, and Yamunotri).",
        "Altitude - 3584 meters above sea level.",
        "The temple is surrounded by the stunning Himalayas with white snow-covered mountains.",
        "The Mandakini river, a tributary of the Alaknanda river, flows through the past of Kedarnath.",
        "Kedarnath town is near the Chorabari glacier, the top of the Mandakini river.",
        "The Yatra begins from Sonprayag town, 5 km from Gaurikund.",
        "Gaurikund is the endpoint, and the Kedarnath Yatra starts from here with a paved footpath.",
        "Distance from Gaurikund to Kedarnath temple is 14 km.",
        "Gaurikund is well connected by roads with vehicle facilities available for pilgrims.",
        "Gaurikund features a hot spring in the middle of the snow-covered landscape.",
        "Passing through Jungle Chatti, Bheembali, and Lichauli, the Kedarnath base camp is 1 km away from the temple.",
        "The temple is open from April end to the beginning of November due to weather conditions.",
        "Kedarnath temple is one of the twelve Jyotirlingas of Lord Shiva.",
        "4G network is available in Kedarnath with BSNL, JIO, and AIRTEL.",
        "An Epass is mandatory to enter Uttarakhand and Kedarnath, available online or at the Sonprayag Yatra pass counter.",
      ],
    },
    duration: "4 Days",
    distance: "19 km",
      ...
      byRoad: [
        {
          type: "text",
          content:
            "There is regular bus service from Delhi to Haridwar, from Delhi's ISBT Kashmere Gate.",
        },
        {
          type: "text",
          content:
  ...
  },
  {
    ...
    title: "Tarsar Marsar Trek - Beautiful Trekking Trail ",
    tourCode: "122132162",
    price: "₹ 11999",
    mapImg: "",
    overview: {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Srinagar to Aru base camp",
        description: [
      ...
      {
        day: "Day 4",
        title: " Shekwas to Tarsar and Explore Tarsar",
        description: [
      ...
      {
        day: "Day 6",
        title: "Visit Marsar and then to Homwas",
        description: [
  ...
  },
  {
    ...
    title: "Spiti valley road trip : The middle land Of Himalaya",
    tourCode: "122132163",
    price: "₹ 21999",
    mapImg: "",
    overview: {
      ...
      paragraphs: [
        "The Spiti Valley Road Trip is like a dream for every person who loves to ride a bike. There is absolutely nothing like riding through the unexplored Himalayan landscape. The road trip begins from Chadigarh and crosses Narkanda, Sangla, Kalpa & Kaza. The weather gets colder and colder as we keep gaining altitude driving along the Spiti River. ",
        "The cold desert-like environment at this high altitude will leave you awestruck. Pin Valley National Park, Ki Monastery, and Hikkim, Komik and Langza villages provide a treat for the eye for anyone who loves being in nature. The Pin Valley National Park is the home to many endangered wildlife species including the hard to spot Snow Leopard. The Spiti Valley Road trip is a perfect opportunity for nature lovers to explore the beauty of Spiti and nearby places.",
      ],
    },
    duration: "8 Days",
    distance: "1090 km",
    ...
    itinerary: [
      {
        ...
        description: [
          "The first day starts with check-in at Chandigarh. You will meet the trip leader who will brief you about the journey. Pay attention to the leader and follow the instructions throughout the trek. Today’s accommodation is not included in the package and you can also shop for supplies that you might need for the journey as the ride begins tomorrow.",
        ],
        briefOverview: [],
      },
      {
        ...
        description: [
          "Our first destination will be Narkanda which is located at an altitude of 8,885 ft above sea level. The destination is famous for the breathtaking views of the snow line, trekking and skiing. The entire journey is a beautiful drive through the mighty mountains of the Himalayas. The drive is 175 Km long and it will take us about 5 hours to reach there. Once we reach Narkanda, you can spend the rest of the day exploring the place and the beauty around the area. Overnight stay will be at a hotel.",
        ],
        briefOverview: [
          "Driving Distance - 175 Km",
          "Driving Time - 5 Hours",
          "Max Altitude - 8,885 ft.",
          "Stay at a hotel.",
        ],
      },
      {
        ...
        description: [
          "After having our lunch, we will embark upon a 160 Km journey to Sangla. Sangla is a picturesque place located at the banks of river Baspa. There are a number of restaurants, cafes and hotels in Sangla which makes it a prime location in the Spiti Valley. We will be spending the night in camps under the starry sky of Sangla. ",
        ],
        briefOverview: [
          "Driving Distance - 160 Km",
          "Driving Time - 8 Hours",
      ...
      },
      {
        ...
        description: [
          "The morning view from Sangla is breathtaking and you will wake up to the mighty Kinner Kailash greeting you. After breakfast, we will continue on with our journey and drive towards Kalpa. The drive is full of pin bends and picturesque views to keep you entertained. After we reach Kalpa, we will check in at a hotel and go out to explore the town. We will be visiting the famous Old Shiva Temple & the Kalpa Monastery. Overnight stay will be at a hotel in Kalpa",
        ],
        briefOverview: [
      ...
      },
      {
        ...
        title: " Kalpa to Kaza",
        description: [
          "We will be leaving early in the morning for a 210 Km ride to Kaza. We will be leaving behind the forests of Kalpa and heading towards the treeline of Spiti. On the route, cold rock mountains, overflowing rivers and icy cold winds will be waiting for you. We will also be visiting Nako Lake on the route. At Kaza, we will check in to a hotel and head out to explore the location. Night stay will be at a hotel.",
        ],
        briefOverview: [
          "Driving Distance - 210 Km",
          "Driving Time - 7 Hours",
          "Max Altitude - 12,467 ft",
          "Night stay in a hotel",
        ],
      },
      {
        day: "Day 5",
        title: "Rest and Sightseeing around Kaza",
        description: [
          "Today is the day to explore the cultural heritage of Kaza and take a break from driving daily. We will visit two small villages known as Langza & Komik in the Spiti Valley. The location is famous for a number of marine fossils that have been found in this area and are believed to date back millions of years. It is believed that the fossils are the remains of the sea creatures who lived here when the entire area was submerged under the Tethys sea. Komik is one of the highest villages of Asia and is famous for a monastery that is located here. ",
          "Post lunch we will also visit the biggest monastery in the Spiti region, known as Ki Monastery. It was built in the 11th century and was home to hundreds of monks who lived here. Night stay will be at the hotel.",
        ],
        briefOverview: ["Resting day", "Explore Kaza"],
      },
      {
        day: "Day 6",
        title: " Kaza to Sarahan",
        description: [
          "After having a delicious breakfast in the morning, we will say goodbye to Kaza and set out towards our next destination at Sarahan. The village has buildings that are mostly made of wood and in Chinese-Bhuddist architecture style. Upon our arrival at Sarahan, we will check in at a hotel and go out to explore the area. We will also be visiting a famous temple known as the Balmiki Temple. Overnight stay will be at a hotel.",
        ],
        briefOverview: [
      ...
      {
        day: "Day 7",
        title: "Sarahan to Chandigarh",
        description: [
          "The final day of the Spiti Valley Trip has arrived and we will be heading back towards Chandigarh. The 274 Km ride will take about 9 hours to complete.",
        ],
        briefOverview: ["Driving Distance - 274 Km", "Driving Time - 9 Hours"],
      },
    ],
    QuickFacts: {},
    howToReach: {
  ...
  },
  {
    ...
    title: "Leh Ladakh Road trip : View Of Play Of Light In Leh",
    tourCode: "122132164",
    price: "₹ 11999",
    mapImg: "",
    overview: {
      ...
      paragraphs: [
        "Leh Ladakh road trip takes a top position amongst any other road trip in India.",
        "Two weeks long and adventurous trip keeps you enthralled and exuberant till the last moment of your trip to Leh Ladakh.",
        "There are two routes to start your Leh Ladakh road trip: one route goes through Chandigarh and another from Srinagar.",
        "From where your journey starts is up to you, it’s all your decision to opt for.",
        "Leh Ladakh offers an extremely stunning sight view at an altitude over 11,400 feet above sea level.",
        "Leh Ladakh road trip is like a dream come true, whether you are solo or in a group, it is beautiful in a dramatic way for everyone who visits.",
        "The journey can be tiring but doesn’t stop your enthusiasm.",
        "The two routes to reach Leh Ladakh are via Srinagar or via Manali.",
        "From Srinagar, you pass through lovely villages, Lamayuru monasteries, Kargil war memorial, Himalayan valley, and more.",
        "Before reaching Srinagar, you will cross the Jawahar tunnel, which is 2.85 km long.",
        "Along the Leh Ladakh road trip, you will travel through stunning locations like Drass valley, Mulbekh, Moonland, Lamayuru, Alchi, Likir, Rohtang La, Keylong, Jispa, Darcha, Zingzing Bar, Baralacha La, Sarchu, Gata loops, Nakee La, Lachulung La, Tanglang La, Upshi, Karu, Pangong Lake, and Nubra valley.",
        "On the way, you’ll witness the precise greenery of Sonmargh and picturesque villages on the bank of the Sindh River.",
        "Srinagar helps you acclimatize easily due to its gradual temperature decrease.",
        "After traveling for around 435 km, you will experience true nature all around you.",
        "The route via Manali is equally attractive with its scenic views of panoramic valleys and high mountains.",
        "On the Manali route, you will experience incredible village lifestyles, monasteries, jaw-dropping views, ancient cultures, and lush greenery.",
        "Upon reaching Ladakh, you will be awestruck by the clouds touching the mountains, providing an amazing view.",
        "The scenic view of the Khardungla pass is a perfect way to continue your trip in Leh.",
      ],
    },
    duration: "12 Days",
    distance: "2,500 km",
    ...
    itinerary: [
      ...
      },
      {
        ...
        briefOverview: [
          ...
          "Altitude Gain - 1729m",
          "Entering the Himalayas, Riding along the Beas River",
        ],
      },
      {
        day: "Day 2",
        title: "Manali to Jispa | 140km",
        description: [
        ...
        briefOverview: [
          ...
          "Altitude Gain - 1150m",
          "Solang Valley, Rohtang La(Pass)",
        ],
      },
      {
        day: "Day 3",
        title: "Jispa to Sarchu | 90km",
        description: [
        ...
        briefOverview: [
          ...
          "Duration - 6 Hours",
          "Altitude Gain - 1090m",
          "Suraj Tal, Baralacha La., Riding along Tsarap River",
        ],
      },
      {
        day: "Day 4",
        title: "Sarchu to Leh | 250km",
        description: [
        ...
        briefOverview: [
          ...
          "Duration - Approx. 8 Hours",
          "Altitude Loss - 1090m",
          "Gata loops, Nakee La, Lachung La, Morey Plains, Tanglang La, Riding along Indus River",
        ],
      },
      {
        day: "Day 5",
      ...
      },
      {
        ...
        briefOverview: [
          ...
          "Altitude Loss - 452m",
          "Khardung La, Diskit Monastery",
        ],
      },
      {
        day: "Day 7",
        title: "Nubra to Pangong Lake | 260km",
        description: [
        ...
        briefOverview: [
          ...
          "Duration - Approx. 8 Hours",
          "Altitude Gain - 1202m",
          "Riding along Shyok River, Water Crossings",
        ],
      },
      {
        day: "Day 8",
        title: "Pangong Lake to Leh | 150km",
        description: [
        ...
        briefOverview: [
          ...
          "Altitude Loss - 750m",
          "Chang La, Druk White Lotus School",
        ],
      },
      {
        day: "Day 9",
        title: "Leh to Kargil | 220km",
        description: [
      ...
      {
        day: "Day 10",
        title: "Kargil to Srinagar | 202km",
        description: [
      ...
      {
        day: "Day 11",
        title: "Srinagar to Pathankot | 330km",
        description: [
      ...
      {
        day: "Day 12",
        title: "PATHANKOT TO CHANDIGARH | 235 KM",
        description: [
  ...
  },
  {
    ...
    title: "Kashmir Great Lakes Trek - Blankets Of Clouds",
    tourCode: "122132165",
    price: "₹ 13399",
    mapImg: "",
    overview: {
      ...
      paragraphs: [
        ...
        "While trekking, trekkers must be equipped with the necessary equipments. Apart from the professional trekking gear, stuffs inclusive of trekking shoes, trekking pole are important specifically. Trekkers must never compromise with their body requirements. Its better to understand your body need and not going by the choice of some other fella. ",
        "The Kashmir Great Lakes Trek is not a childs game but even a child of ten years can go on this trek. The luggage or the carry bag should be as light as possible. It will be in your comfort.",
        "Who can go",
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrive at Sonamarg",
        description: [
          "Depart to Sonamarg in the afternoon. It is 3 hrs drive from Srinagar.",
        ],
        briefOverview: [
          "Altitude: 7800 ft",
          "Distance from Srinagar: 90 kms (approx 3 hours drive)",
          "Pickup (if booked in advance): The Crazy Mountaineers at 3pm from TRC",
          "Campsite Location: Near Sindh river (Shitkadi Village)",
          "Shop Availability: No shops around, ensure you have everything you need",
          "ID Proof Requirement: Original ID required, 2 photo copies to submit at Army check post",
        ],
      },
      {
        day: "Day 2",
        ...
        description: [
          "Trek Ascent and Descent: 3-hour ascent, 1-hour descent, followed by a gentle ascent to Nichnai (6 hours, 9 kms)",
          "Trek Starting Point: 3 kms from Sonamarg on the Srinagar road",
          "Last Stop for Supplies: Lone Dhaba on the right at the 3 km mark (sells water, biscuits, etc.)",
          "Dwelling Civilizations: Next dwelling is only at Naranag at the end of the trek",
          "Trek Route: Jeep track diverges to the right off the main road, reaching the Sindh river level, then quickly ascends",
          "Initial Meadow: 10 minutes into the trek, the trail enters a green meadow overlooking Sonamarg town",
          "Maple and Pine Trees: Half an hour into the trek, reach the top of the meadow with Maple and Pine trees",
          "Forest Descent: Trail descends to a tiny brook, then ascends through a dense Maple forest",
          "Maple Forest Trek: 1.5 hours through Maple trees with green grass beds, a unique Kashmiri experience",
          "Trail View: Clearings provide views of the Sonamarg valley as you gain height",
          "Ridge View: At the ridge, enjoy panoramic views of Sonamarg and the valley",
          "Shekdur Meadow: Gentle descent into a meadow lined with Silver Birch trees and shepherd huts, about 2.5 hours from road head",
          "Water Sources: Small brooks in the Shekdur meadow serve as water sources",
          "Shekdur Campsite: Surrounded by Bhoj trees, unique for photography; good for camping if starting from Srinagar",
          "Lunch Spot: If starting from Sonamarg, Shekdur is a lunch spot; continue to Nichnai",
          "Shekdur to Birch Forest: Meadow stretches for half an hour; gentle descent ends in a forest of Bhoj/Silver Birch",
          "Birch Forest Trail: Trail descends gently through the forest, creating a light-and-shadow effect",
          "Nichnai Valley: After 45 minutes, Birch forest ends, leading to a river valley—the start of Nichnai",
          "River Valley Path: Follow the right bank of the river, going upstream with views of Sonamarg snow-clad peaks",
          "Wide Valley: Valley widens with green meadows, enclosed by mountain ranges on either side",
          "Rocky Path: First 30 minutes over rocks; mules proceed slowly here",
          "Final Meadow: Green meadow widens in the valley with views of twin snow-clad peaks ahead, ideal for camping",
        ],
        briefOverview: [
          "Altitude: 7,800 ft to 11,500 ft",
          "Trek Distance: 11 kms, approx 8 hours",
          "Trek Route: After breakfast, trek to Nichnai via Shekdur",
          "Trail Highlights: Meadows, dense forests with Maple, Pine, and Bhoj trees",
          "Army Check Post: Submit ID proofs approx half an hour into the trek",
          "Scenic Views: Enjoy views of Sonmarg Valley and Thajiwas Glacier",
          "Trek Segment 1: Shitkadi to Shekdur, approx 2.5 hours through pine forests",
          "Food at Shekdur: Option for instant noodles and an omelette",
          "Trek Segment 2: Shekdur to Nichnai following the Nichnai Stream",
          "Lunch Spot: Nichnai stream, after Shekdur",
        ],
      },
      {
        day: "Day 3",
        title: "Nichnai (11,500ft) to Vishansar lake (12,00ft)",
        description: [
          "Day's Trek: Medium climb to Nichnai Pass (13,500 ft), followed by a descent and flat meadow walk ending near Vishansar Lake (12 kms, approx 6 hours)",
          "Start Time Recommendation: Begin at 8 am to fully enjoy the meadows",
          "First Destination: Nichnai Pass, visible from the campsite, located near twin snow-clad peaks",
          "River Crossing: After 30 minutes along the river, cross to the left bank, walking for an hour",
          "Meadow Ascent: Trail ascends gradually through meadow; next hour is a climb to Nichnai Pass",
          "Scenic Spot: Small deep blue lake at the foot of mountains, raising expectations for main lakes",
          "Deceptive Pass: Nichnai Pass is reached after the trail bends twice (not visible from below)",
          "Views from Nichnai Pass: Overlooks Sonamarg Valley and previous trail, last BSNL phone network point on trek",
          "Pass Characteristics: Wide tunnel-like pass at 13,500 ft, with snow-clad peaks on the left",
          "Altitude Effects: Fast ascent may cause mild altitude sickness, but trail descends from here",
          "Rocky Descent: Trail descends rapidly; rocks give way to grass and red flowers",
          "Wide Meadow: Ahead lies a vast green meadow with peaks on both sides and a new river from the pass",
          "Waterfall View: Large waterfall joins the river in the meadow, transitioning to a flatter path",
          "Diverse Scenery: Snow-clad peaks on the left; barren, Ladakh-like mountains on the right",
          "Stream Crossings: Two main streams flow through the valley; stick to the left stream",
          "Cold Stream Crossing: Cross icy-cold stream in half an hour, followed by meadow walk",
          "End of Valley: Reach another perpendicular stream flowing from Vishansar Lake",
          "Campsite Near Stream: Ample camping space near the stream from the lake, about 0.5 km left of Vishansar Lake",
          "Vishansar Lake Location: 7-minute walk from campsite, nestled below four mountains",
          "Lake Reflections: Kishansar Peak reflects in the lake, color varies with time and weather",
          "Lake Colors: Clear in early morning; blue on sunny days; greenish-blue later in the day",
          "Trout Fishing: Lake filled with trout; fishing permits available in Srinagar",
        ],
        briefOverview: [
          "Altitude Range: 11,500 ft to 12,000 ft, passing via Nichnai Pass at 13,100 ft",
          "Trek Distance and Duration: 12 kms, approx 7 hours",
          "Nichnai Ascent: 1.5-hour ascent from Nichnai to Nichnai Pass",
          "Network Availability: B.S.N.L network available at Nichnai Pass, last mobile coverage point",
          "Descent to Vishansar: Nichnai Pass to Vishansar involves a descent",
          "Vishansar Campsite: Lunch provided at the Vishansar campsite",
          "Vishansar Lake Proximity: 15-minute walk from the campsite",
          "Vishansar Lake: First and one of the most beautiful lakes on the trek",
          "Lake Condition in July: Frozen lake if visiting in July; otherwise, fishing permitted with Srinagar Fishing Department permission",
          "Shepherds and Stories: Vishansar is frequented by shepherds with interesting stories",
          "Recreation at Campsite: Open ground suitable for volleyball, cricket, etc.",
          "Campsite Caution: Beware of dogs at the campsite",
        ],
      },
      {
        day: "Day 4",
        title: "Acclimatization + Rest Day. (Condition Apply)",
        description: [
          "Kishansar Lake Visit: 1.5 kms from Vishansar campsite",
          "Weather Contingency: If weather is poor, use acclimatization day at Vishansar",
          "Rest Day Option: If weather permits, proceed to next campsite; rest day can be taken at Gangbal campsite",
        ],
        briefOverview: [],
      },
      {
        ...
        description: [
          "Trek Route: Steep 2-hour ascent, followed by a steep descent, then a gentle walk through meadows (10 kms, approx 5 hours)",
          "Kishansar Lake: Next in lake series, 0.5 km away and 500 ft higher than Vishansar Lake",
          "Time to Reach Kishansar: 45-minute trek from Vishansar campsite",
          "Trail to Kishansar: Multiple tracks; right side trail climbs up for better views, flatter trails for easier walk",
          "Photography Tip: Higher trails offer better views of the meadow and lake",
          "Lake Proximity: Although only 1.2 km apart, there’s no spot where both lakes are visible together",
          "Gadsar Camp Options: Option to camp next to Gadsar or continue to Gadsar Army Camp",
          "Gadsar Army Camp: Located further downhill, a small hut with 5-8 army personnel",
          "Permission Requirement: Permission needed from Army HQ to move beyond Gadsar camp",
          "Army HQ: Located 3 miles away, near a village in the tree line; equipped with a satellite phone",
          "Check-in Process: Report at Gadsar camp to initiate permission request; process can take 2-3 hours",
          "ID Check: All trekker details and original ID cards are recorded, collected, and verified by army staff",
        ],
        briefOverview: [
          "Altitude Range: 12,000 ft to 12,000 ft, passing via Gadsar Pass at 13,750 ft (highest point of the trek)",
          "Trek Distance and Duration: 14 kms, approx 10 hours",
          "Early Start: Begin trek earlier than usual",
          "Route Overview: Trek from Vishansar to Gadsar via Gadsar Pass",
          "Steep Ascent: Trail ascends steeply from Vishansar to Gadsar Pass",
          "View of Kishansar Lake: Visible along the way to Gadsar Pass",
          "Descent to Campsite: Gradual descent from Gadsar Pass to Gadsar campsite",
          "Gadsar Lake: Lake is visible en route, along with the Gadsar Glacier",
          "Campsite Arrival: Approximately 2 hours from Gadsar Lake to the campsite",
          "Army Checkpoint: Checkpoint near campsite where ID proofs are required",
          "Lunch: Pack lunch provided for the trek",
        ],
      },
      {
        day: "Day 6",
        ...
        description: [
          "Trek Overview: Gentle 1-hour descent, followed by a steep 3-hour ascent, and then a flat meadow walk (12 kms, approx 6 hours)",
          "Starting Point: Army camp, move left towards the stream",
          "Stream Altitude: 10,600 ft",
          "Stream Crossing Options: Easiest way is to cross the stream directly; alternative is to go to the bridge 1 km away to avoid getting wet (steeper climb from the bridge)",
          "Mountain Climb: After the stream, follow trail up the mountain, similar to Western Ghats terrain",
          "Elevation Gain: Climb takes approximately 1.5 hours and ascends 1,100 ft",
          "Meadow Walk: Trail flattens at 11,500 ft and continues in a meadow surrounded by mountains",
          "Maengandob: Area with deep craters visible to the right",
          "Camping Options: Camp at Maengandob if last camp was Gadsar Lake; otherwise, continue to Satsar",
          "Satsar Lakes: Collection of 7 lakes, 4-5 typically with water depending on the season",
          "Satsar Army Check Post: 3rd line of defense from LOC; ID check required, similar to previous checkpoints",
          "First Satsar Lake: Located 10 minutes from army camp, large and picturesque, suitable for camping",
        ],
        briefOverview: [
          "Altitude Range: 12,000 ft to 12,000 ft",
          "Trek Distance and Duration: 9 kms, approx 6 hours",
          "Seasonal Highlight: Trail is vibrant with flowers from mid-July to mid-August",
          "Army Checkpoint: ID check required at another army check post en route",
          "False Lakes: Two small lakes visible on the way, often mistaken for Satsar Lakes",
          "Satsar Twin Lakes: Known as Mengen Top, located between the mountains",
          "Afternoon Visit: Plan to visit the Satsar twin lakes, approximately 1.3 hours from the trail",
        ],
      },
      {
        day: "Day 7",
        title: "Satsar (12,000ft) to Gangabal twin lakes (11,500ft)",
        description: [
          "Trek Overview: Mild ascent, gradual descent, long steep ascent and descent, followed by gradual up and down walk (9 kms, approx 6 hours)",
          "Trek Terrain: Up and down, replicating the general trek pattern",
          "First Segment: Trek for 30 minutes out of camp to reach the largest Satsar lake; bouldery terrain requiring boulder hopping",
          "Largest Satsar Lake: The last in the Satsar sequence",
          "Descent: After the last lake, descend for 30 minutes on the main trail; forest line appears on the left, ridgeline on the right (1,000 ft higher)",
          "Climb: Base altitude 11,800 ft; take a zigzag pony trail to ascend the first ridge in about 45 minutes with minimal breaks",
          "Ridges: First ridge offers views of additional ridges to climb; barren and rocky terrain",
          "Scenery: Gujjar huts visible amidst pines across the mountain",
          "Nundkhol Lake: Located at the base of Harmukh peak; nearby Harmukh glacier",
          "Gangabal Lake: 20 minutes from Nundkhol, linked by a stream on the right side of both lakes",
          "Stream Crossing: Cross the stream closer to Gangabal using a man-made bridge on the right side",
          "Lake Exploration: Gangabal and Nundkhol are large; a parikrama (circle) around either lake takes approximately 1 hour",
          "Activities: Both lakes are popular for trout fishing",
        ],
        briefOverview: [
          "Altitude Range: 12,000 ft to 11,500 ft, passing through 13,000 ft",
          "Trek Distance and Duration: 11 kms, approx 6 hours",
          "Terrain: Walk on rocky paths for about an hour, ascend till Jazz Pass",
          "Jazz Pass: Enjoy views of 4 lakes, Mt. Harmukh, and its glacier from the pass",
          "Descent: After the pass, descend towards Gangbal Lake and camp at Nandkol Lake",
          "Gangbal Lake: One of the largest lakes on the trek, a key destination",
          "Evening Activity: Post-dinner traditional Kashmiri songs and dance performance by the staff",
        ],
      },
      {
        day: "Day 8",
        title: "Gangabal to Naranag Drive to Srinagar",
        description: [
          "Prepaid Sim Cards: Do not work in Kashmir, ensure you have another means of communication.",
          "ID Proof: Don't forget your original ID and 2 photocopies.",
          "Arrival in Srinagar: On Day 8, you'll reach between 6:30 pm and 7:30 pm. You can book your travel anytime after 8 pm.",
          "Trek Distance and Duration: Gradual descent followed by steep descent, 6 hours, 11 kms.",
          "Day's Trek: The trek is hard on your toes and knees.",
          "Start: Head down from Gangbal campsite along the stream, avoiding walking beside it. Stick to the ridge on the right.",
          "Cell Network: 30 minutes into the trail, your Aircel phone may briefly show network.",
          "Meadow and Views: A green flat meadow with yellow flowers and views of Harmukh peak.",
          "Tree Line: In about an hour, you reach the tree line with pine trees and a log hut.",
          "Elevation: From 10,800 ft, you climb to 11,000 ft, making your way in and out of the pine forest.",
          "Descent: The steep descent begins after about 2/3 of the distance, losing 3,000 ft in the last 4 kms.",
          "Naranag: The village of Naranag comes into sight at around 8,500 ft, and the last stretch follows a stone-paved track leading to the main road.",
        ],
        briefOverview: [
          "Altitude: 11,500 ft to 7,450 ft.",
          "Trek Distance and Duration: 15 kms, approx 7 hours.",
          "Trail: The entire trek is a descent, so take care of your knees and ankles.",
          "Terrain: The trail passes through pine tree forests.",
          "Transport: On advance booking, The Crazy Mountaineers can arrange transport to Srinagar at an additional charge.",
          "Arrival in Srinagar: After a 70 km drive, you will reach Srinagar by 6:30 pm.",
        ],
      },
    ],
    QuickFacts: {},
  ...
  {
    name: "Do Dham Yatra",
    title: "Do Dham Yatra - Kedarbadri",
    tourCode: "122132166",
    price: "₹ 13399",
    mapImg: "",
    overview: {
      title: "Do Dham Yatra",
      paragraphs: [
        "Do Dham Yatra is a two Dham yatra of Kedarnath and Badrinath, also popular as Kedarbadri Yatra.",
        "Do Dham is one of the most popular Yatras among the Char Dham Yatra (Kedarnath, Badrinath, Yamunotri, Gangotri).",
        "Kedarnath falls in the Rudraprayag district, and Badrinath falls in the Chamoli district of Uttarakhand, India.",
        "You can set off your Do Dham Yatra from either Rishikesh or Haridwar.",
        "If starting from Haridwar, your first stop will be Guptkashi, which is about 7-8 hours away.",
        "Stay at Guptkashi or Sonprayag for rest before continuing the journey.",
        "On the second day, you will go from Guptkashi or Sonprayag to Gaurikund, the base for the Kedarnath trek.",
        "At Sonprayag, you will need to pass through the biometric process (free of cost).",
        "Sonprayag is located near the Mandakini River, which originates from the Chorabari glacier near Kedarnath.",
        "From Gaurikund, the trek to Kedarnath temple is about 19 km.",
        "The scenic beauty of Gaurikund and the hot springs are considered sacred in Hindu mythology.",
        "The trekking route passes through Bhimchatti, Jungle Chatti, and Lichauli, where camp facilities are available.",
        "The Kedarnath trekking route offers stunning waterfalls, enchanting nature views, and bird sounds.",
        "Kedarnath temple is located at an altitude of 3584 meters and is dedicated to Lord Shiva.",
        "You can worship and offer prayers at the Kedarnath temple, experiencing a great sense of joy and peace.",
        "On the third day, you will travel from Guptkashi to Joshimath, approximately 6-7 hours (145 km).",
        "Badrinath temple is around 45 km from Joshimath.",
        "Stay at Joshimath on the third day and visit the Badrinath temple on the fourth day.",
        "Badrinath temple is located at an altitude of 3300 meters and is dedicated to Lord Vishnu.",
        "The Badrinath temple is surrounded by beautiful hills, with the Alaknanda river flowing in front of it.",
        "The Tapt Kund in Badrinath has hot springs, and pilgrims often bathe in it before worshipping at the temple.",
        "The Do Dham Yatra opens from the end of April to the beginning of November, depending on weather conditions.",
      ],
    },
    duration: "6 Days",
    distance: "19 km",
